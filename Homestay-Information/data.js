const destinations = [
    {
      ...
      rating: 9.2,
      cost: "230.000 VND",
      reviews: "Tôi đã có một kỳ nghỉ tuyệt vời tại khách sạn này. Phòng sạch sẽ và thoải mái, nhân viên thân thiện và nhiệt tình phục vụ. Tôi sẽ quay lại lần nữa!",
      amenities: ["Wifi", "Bar"]
    },
    {
      id: 2,
      ...
      rating: 8.8,
      cost: "450.000 VND",
      reviews: "Không gian hồ bơi tại đây thực sự tuyệt vời. Tôi đã có những khoảnh khắc thư giãn tuyệt vời bên bể bơi và thưởng thức thời tiết nắng đẹp",
    ...
    },
    {
      ...
      rating: 9.7,
      cost: "850.000 VND",
      reviews: "Phòng tắm của tôi cần được sửa chữa một chút vì có một vài vấn đề về cống nước. Tuy nhiên, sau khi thông báo với nhân viên, họ đã giải quyết vấn đề ngay lập tức.",
      amenities: ["Wifi"]
    },
    {
      id: 4,
      ...
      rating: 9.5,
      cost: "500.000 VND",
      reviews: "Tôi đánh giá cao dịch vụ phòng ở đây. Phòng luôn được dọn dẹp kỹ lưỡng và có mọi thứ cần thiết để tạo cảm giác như ở nhà.",
      amenities: ["Wifi"]
    },
    {
      id: 5,
      ...
      rating: 8.5,
      cost: "300.000 VND",
      reviews: "Khách sạn này có vị trí tuyệt vời, gần các điểm du lịch chính và những cửa hàng địa phương. Tuy nhiên, dịch vụ phòng cần cải thiện hơn một chút.",
    ...
    },
    {
      ...
      rating: 8.5,
      cost: "450.000 VND",
      reviews: "Đánh giá khách hàng về khách sạn 1.Nhân viên tại quầy lễ tân luôn thân thiện và nhanh nhẹn. Họ luôn sẵn lòng giúp đỡ và tạo điều kiện tốt nhất cho kỳ nghỉ của tôi.",
    ...
    },
    {
      ...
      rating: 9.7,
      cost: "650.000 VND",
      reviews: "Khách sạn này có một quầy bar tuyệt vời với các loại cocktail ngon và không gian lounge thoải mái. Tôi đã thưởng thức một buổi tối tuyệt vời tại đây.",
